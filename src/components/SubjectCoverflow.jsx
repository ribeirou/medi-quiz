    ...
    <div>
        ...
        {items.map((item, index) => {
          ...
          return (
            <motion.button
              ...
              className="absolute left-1/2 top-1/2 w-48 sm:w-56 -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-slate-200 bg-white p-5 shadow-lg cursor-pointer focus-visible:outline-2 focus-visible:outline-blue-600"
            >
              <div
              ...
              <h3 className="mt-3 text-base font-semibold text-slate-900 text-left">
                {item.subject.name}
              </h3>
              {isCenter && (
              ...
              {isCenter && accuracy !== null && (
                <span className="mt-2 inline-block text-xs font-medium px-2 py-1 rounded-full bg-slate-100 text-slate-600">
                  {accuracy}% acerto
                </span>
              )}
            </motion.button>
      ...
      <div className="flex items-center justify-center gap-4 mt-4">
        <button
          ...
          className="h-9 w-9 rounded-full border border-slate-200 bg-white shadow-sm flex items-center justify-center text-slate-600 disabled:opacity-30 disabled:cursor-not-allowed hover:border-blue-200"
        >
          ‹
        </button>
