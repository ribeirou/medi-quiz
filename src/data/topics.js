...
export const topicsBySubject = {
  ...
  fisiologia: [
    ...
    { name: 'Sistema Nervoso Autônomo', icon: '🧠', ids: ['fisio-36', 'fisio-37', 'fisio-38', 'fisio-41', 'fisio-42', 'fisio-66'] },
    { name: 'Sinapses e Receptores Sensoriais', icon: '⚡', ids: ['fisio-59', 'fisio-60', 'fisio-61', 'fisio-62', 'fisio-63', 'fisio-64', 'fisio-65', 'fisio-67', 'fisio-68', 'fisio-69'] },
