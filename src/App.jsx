  ...
  return (
    <section className="relative overflow-hidden border-b border-slate-100 dark:border-slate-800">
      ...
      <div className="absolute top-4 right-4 flex items-center gap-2">
        {(xp > 0 || streak.count > 0) && (
          <>
            <span className="text-sm font-medium text-orange-600 dark:text-orange-400 bg-white/80 dark:bg-slate-800/80 backdrop-blur px-2.5 py-1 rounded-full border border-orange-100 dark:border-orange-900/50">
              🔥 {streak.count}
            </span>
